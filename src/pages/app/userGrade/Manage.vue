  ...
  <div>
    <div class="panel panel-default panel-search">
      <el-form :inline="true">    
        ...
        <el-form-item label="">
          <el-switch v-model="page.query.param.value1" active-text="邀请码开启" inactive-text="关闭邀请码"></el-switch>
        </el-form-item>
      </el-form>     
    </div>
    ...
    <v-table ref="table" :page="page" :table-minheight="450" class="panel-main">
      ...
      <el-table-column prop="repplaceBookingNumber" label="邀请码数" ></el-table-column>
